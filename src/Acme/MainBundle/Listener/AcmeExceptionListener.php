...
class AcmeExceptionListener extends ContainerAware implements EventSubscriberInterface
{
    public function onKernelException(GetResponseForExceptionEvent $event)
    {
        ...
        $response = new Response("<html><body>
            <h2>Acme</h2>
            <p>If you see this page, it means your acme is not correctly set up.
               Please see the README file in the acme root folder and if you can't figure out
            ...
            <p>If you are seeing this page as the result of an edit in the admin tool, please report what you were doing
                to our <a href=\"https://github.com/symfony-cmf/symfony-cmf-standard/issues/new\">ticket system</a>,
